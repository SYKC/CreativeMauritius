...
class MistakesWereMade extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
      ...
      DB::update('ALTER TABLE `users` MODIFY `username` VARCHAR(255) NULL');
      DB::update('ALTER TABLE `users` MODIFY `email` VARCHAR(255) NULL');
    }
}
